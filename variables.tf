...
variable "instance_class" {
  description = "Instance class to use for the DB instances in the cluster"
  type        = string
}
...
variable "vpc_id" {
  description = "ID of the VPC to create the DB cluster in"
  type        = string
}

variable "subnet_ids" {
  description = "List of subnet IDs to create the DB cluster in"
  type        = list(string)
}
...
variable "ssm_parameter_enabled" {
  description = "Whether to create an SSM parameter for the master password"
  type        = bool
  default     = true
}
